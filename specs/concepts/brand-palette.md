...
that joins, the year the card is valid for, the confirmation that a payment
went through.
...
- The [member card](member-card.md) is drawn from this palette: white on the
  cream page, ink, one moss rule and label, the red heart.
