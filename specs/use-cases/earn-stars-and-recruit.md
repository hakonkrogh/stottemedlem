# Use case: Earn stars and recruit new members

**Status:** Draft
**Solves:** [Problem: Loyalty is invisible and word of mouth goes untracked](../problems/invisible-loyalty-and-word-of-mouth.md)

## Goal
A supporting member sees their loyalty recognized as stars, can prove and show
...
1. The member sees their [scorecard](../concepts/scorecard.md): one star per
...
- The member list shows each member's stars and recruit count, so loyalty and
  recruiting can be seen and thanked.

## Acceptance criteria
- [ ] Stars equal the number of annual periods the member has supported this
...
- [ ] The member can see their own stars and recruit count at any time.

## Out of scope
- Rewards, discounts, or tier changes tied to stars or recruits — recognition
  only, for now.
...
- Cross-organization aggregation of stars.
