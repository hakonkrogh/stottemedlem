...
3. The **back office shows the card itself** on the organization's front page,
...
4. The administrator can **download** the card, and the QR code alone, as image
...
5. An external website (typically the organization's own site) can **embed** the
...
6. The **marketing front page** showcases this: it shows a live preview of a
