...
4. **Members are told before the new price is charged**, by the product itself,
...
5. A member who has already been told what their next renewal will cost is not
   ...
   the coming year.
6. A member the product has no way to reach cannot be told, and therefore never
...
7. A [lapsed](renew-annual-membership.md) member who comes back pays the fee
   current when they return, like any other new join.
8. What a member actually paid, in every year, stays recorded as it was. History
